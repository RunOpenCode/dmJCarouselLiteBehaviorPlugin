...
class dmJCarouselLiteBehaviorForm extends dmBehaviorBaseForm
{
    ...
    public function getJavascripts()
    {
        return array(
            'lib.ui-tabs',
            'core.tabForm',
            'dmJCarouselLiteBehaviorPlugin.form'
        );
    }

    protected function renderContent($attributes)
    {
        return $this->getHelper()->renderPartial('dmBehavior', 'forms/dmJCarouselLiteBehavior', array(
                'form' => $this,
                'baseTabId' => 'dm_behavior_dmjcarousellite_' . $this->dmBehavior->getId()
            ));
    }
